                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-4 text-right">
                                        <a href="{{ route('user.index') }}"
                                           class="btn btn-sm btn-primary">{{ __('account.back_list') }}</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="pl-lg-4">
                                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="name" id="input-name"
                                                   ...
                                                   placeholder="{{ __('account.name') }}" value="{{ old('name') }}" required
                                                   autofocus>
                                        ...
                                        <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="email" name="email" id="input-email"
                                                   ...
                                                   placeholder="{{ __('account.email') }}" value="{{ old('email') }}" required>
                                        ...
                                        <div class="form-group{{ $errors->has('password') ? ' has-danger' : '' }}">
                                            <label class="form-control-label"
                                                   for="input-password">{{ __('account.password.password') }}</label>
                                            <input type="password" name="password" id="input-password"
                                                   class="form-control form-control-alternative{{ $errors->has('password') ? ' is-invalid' : '' }}"
                                                   placeholder="{{ __('account.password.password') }}" value="" required>
