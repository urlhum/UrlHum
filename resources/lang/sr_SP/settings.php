...
return [
    ...
    'min_hash_length' => 'Minimum URLs hash length. Do not edit if you already have many Short URLs in Database',
    'min_hash_length_help' => 'Minimum number of characters of which the short URL part must be. It is NOT recommended to edit this value if you already have URLs in your database.'
];
